...
import (
	context "context"
	example "go-template/internal/repository/example"
...
func (_m *Repository) AddRecords(ctx context.Context, payload []*example.Example) error {
	ret := _m.Called(ctx, payload)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []*example.Example) error); ok {
		r0 = rf(ctx, payload)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *Repository_AddRecords_Call) Run(run func(ctx context.Context, payload []*example.Example)) *Repository_AddRecords_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]*example.Example))
	})
	return _c
}
...
func (_c *Repository_AddRecords_Call) RunAndReturn(run func(context.Context, []*example.Example) error) *Repository_AddRecords_Call {
	_c.Call.Return(run)
	return _c
}

// GetRecords provides a mock function with given fields: ctx, ids
func (_m *Repository) GetRecords(ctx context.Context, ids []int) ([]*example.Example, error) {
	ret := _m.Called(ctx, ids)

	var r0 []*example.Example
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []int) ([]*example.Example, error)); ok {
		return rf(ctx, ids)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []int) []*example.Example); ok {
		r0 = rf(ctx, ids)
	} else {
		if ret.Get(0) != nil {
...
func (_c *Repository_GetRecords_Call) Return(_a0 []*example.Example, _a1 error) *Repository_GetRecords_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Repository_GetRecords_Call) RunAndReturn(run func(context.Context, []int) ([]*example.Example, error)) *Repository_GetRecords_Call {
	_c.Call.Return(run)
	return _c
}
